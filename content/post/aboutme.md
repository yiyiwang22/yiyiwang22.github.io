...
<style>
/* =========================================================
   Academic Homepage — Yiyi Wang (Dark Mode Supported)
   ========================================================= */
...
.profile-wrapper {
  ...
  --bg-card: linear-gradient(135deg, rgba(244, 247, 252, 0.95), rgba(250, 247, 253, 0.95));
  --bg-edu: rgba(247, 243, 252, 0.48);
  --border-card: rgba(140, 159, 226, 0.16);
  --avatar-border: rgba(255, 255, 255, 0.9);

  --note-text: #8b6bb0;
  --note-bg: rgba(180, 135, 230, 0.09);
  
  --shadow-card: 0 8px 26px rgba(55, 65, 81, 0.07);
  --shadow-pub: 0 3px 12px rgba(55, 65, 81, 0.045);
...
/* ================= 夜间模式 (Dark Mode) 颜色 ================= */
/* 1. 适配系统级夜间模式 (如 macOS/Windows 系统设置为深色) */
@media (prefers-color-scheme: dark) {
  .profile-wrapper {
    --text-main: #e5e7eb !important;
    --text-bold: #f9fafb !important;
    --text-role: #d1d5db !important;
    --text-affil: #9ca3af !important;
    --text-detail: #9ca3af !important;

    --bg-card: rgba(31, 41, 55, 0.6) !important;
    --bg-edu: rgba(55, 65, 81, 0.4) !important;
    --border-card: rgba(255, 255, 255, 0.1) !important;
    --avatar-border: #374151 !important;

    --note-text: #c99dfa !important;
    --note-bg: rgba(180, 135, 230, 0.15) !important;

    --shadow-card: 0 8px 26px rgba(0, 0, 0, 0.5) !important;
    --shadow-pub: 0 3px 12px rgba(0, 0, 0, 0.4) !important;
  }
}

/* 2. 适配网站自带的夜间模式切换按钮 (Hugo 主题常用的全局 class) */
...
.profile-wrapper img.avatar-img {
  ...
  border: 3px solid var(--avatar-border) !important;
...
.profile-wrapper p.profile-affiliation {
  ...
  color: var(--text-affil) !important;
}
...
.profile-wrapper .education-entry {
  ...
  background: var(--bg-edu) !important;
...
.profile-wrapper .publication-entry {
  ...
  background: var(--bg-card) !important;
  box-shadow: var(--shadow-pub) !important;
}
...
<p class="profile-affiliation">University of South Florida · Advised by <a href="http://shareefahmed.myweb.usf.edu/">Prof. Shareef Ahmed</a></p>
 ...
 <!-- <a href="https://www.linkedin.com/in/yiyi-wang-0551b7179/">LinkedIn</a></p> -->
</div>
</div>
